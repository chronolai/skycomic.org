...
class Cron extends CI_Controller {
	...
	public function u_t_8 () {
		$this->load->model('sites/site_8comic', 'mod');
		$this->mod->execute('title');
	}

	public function u_c_8 () {
		$this->load->model('sites/site_8comic', 'mod');
		$this->mod->execute('chapter');
	}

	public function u_t_9 () {
		$this->load->model('sites/site_99comic', 'mod');
		$this->mod->execute('title');
	}

	public function u_c_9 () {
		$this->load->model('sites/site_99comic', 'mod');
		$this->mod->execute('chapter');
	}

	public function u_t_x () {
		$this->load->model('sites/site_xxbh', 'mod');
		$this->mod->execute('title');
	}

	public function u_c_x () {
		$this->load->model('sites/site_xxbh', 'mod');
		$this->mod->execute('chapter');
	}
